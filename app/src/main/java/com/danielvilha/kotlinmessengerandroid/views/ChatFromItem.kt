 ...
 */
class ChatFromItem(val text: String, var user: User): Item<ViewHolder>() {

    override fun bind(viewHolder: ViewHolder, position: Int) {
        viewHolder.itemView.txv_chat_from.text = text

        val url = user.profileImageUrl
        val targetImageView = viewHolder.itemView.img_avatar_from
